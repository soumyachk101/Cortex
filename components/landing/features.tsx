...
const FEATURES = [
  {
    icon: Wallet,
    title: 'Expense Tracking & Receipts',
    description: 'Log expenses manually or scan receipts & PDFs with AI. Visual breakdowns and monthly trends.',
  ...
  },
  {
    ...
    description: 'Speak in Hindi/English or upload bills & live camera photos. Powered by Gemini 2.5 & Groq Llama 3.3.',
  ...
  },
  {
    ...
    description: 'Deep spending analytics, budget limit warnings, and proactive savings advice.',
  ...
  },
  {
    ...
    description: 'Quick capture ideas, meeting notes, and repeat reminders (daily, weekly, custom).',
  ...
  },
  {
    ...
    description: 'Protected with Supabase Auth, Cloudflare Turnstile CAPTCHA, and secure API storage.',
